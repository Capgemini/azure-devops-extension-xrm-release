...
Export-Dynamics365Data -BatchSize $batchSize -PageSize $pageSize -TopCount $topCount -SchemaFilePath $schemaFilePath -JsonFolderPath $jsonFolderPath -ConnectionString $connectionString -OnlyActive:$onlyActiveVaraible -ConfigFilePath:$configFilePath -TreatWarningsAsErrors:$treatWarningsAsErrorsVariable
